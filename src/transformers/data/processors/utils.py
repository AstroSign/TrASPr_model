...
class InputExample(object):
    ...
    def __init__(self, guid, text_a, text_b=None, label=None, consval=None, cat=None, features=None, tissue_rep=None):
        self.guid = guid
        self.text_a = text_a
        self.text_b = text_b
        self.label = label
        self.consval = consval
        self.cat = cat
        self.features = features
        self.tissue_rep = tissue_rep
...
class InputFeatures(object):
    ...
    def __init__(self, input_ids, attention_mask=None, token_type_ids=None, label=None, consval=None, cat=None, features=None,tissue_rep=None):
